...
opdesc SLEEP,	31,0xFF,0xFF,0xFF,0xFF,0xFF
opfunc SLEEP
...
;?????? need to check
opdesc MOVW_A,	47,0xff,6,0xff,21,0xff
opfunc MOVW_A
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov ecx,[r12]       ;2
...
opdesc MOVL_A,	51,0xff,6,0xff,21,0xff
opfunc MOVL_A
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov eax,[r12]       ;2
...
opdesc TST_B,	36,0xff,0xff,0xff,28,0xff
opfunc TST_B
ctrlreg_load 1        ;5
mov  ecx,[rbp]        ;3 Get GBR
...
opdesc TRAPA,	85,0xFF,0xFF,0xFF,57,0xFF
opfunc TRAPA
mov  rbp,rdi          ;2
add  rbp,byte 60      ;3
sub  dword [rbp],4    ;7
...
opdesc BT,	29,0xFF,0xFF,0xFF,15,0xFF
opfunc BT
and r14d,dword 0   ;7
bt dword [rbx],0    ;4
jnc .continue       ;2
...
opdesc BF,	29,0xFF,0xFF,0xFF,15,0xFF
opfunc BF
and r14d,dword 0   ;7
bt dword [rbx],0    ;4
jc .continue        ;2
...
opdesc LDS_MACH_INC,	28,0xFF,6,0xFF,0xFF,0xFF
opfunc LDS_MACH_INC
mov rbp,rdi            ;2
add rbp,byte $00       ;3
mov ecx,[rbp]          ;2
...
opdesc MOVLI,	43,0xFF,6,0xFF,11,0xFF
opfunc MOVLI
mov rbp,rdi         ;2
add rbp,byte $00    ;3
xor rax,rax         ;2
...
opdesc MOVBS4,	32,9,0xFF,15,0xFF,0xFF
opfunc MOVBS4
...
opdesc MOVWS4,	34,9,0xFF,15,0xFF,0xFF
opfunc MOVWS4
mov rbp,rdi         ;2  Get R0 address
mov edx, [rbp]      ;3  Set to Func
add rbp,byte $00    ;3  Get Imidiate value R[n]
...
;===============================================================
opdesc DIV1,	389,62,6,0xFF,0xFF,0xFF
opfunc DIV1
...
;        (MACH << 32 + MACL)  + ans 
;-------------------------------------------------------------
opdesc MAC_L,	145,6,38,0xFF,0xFF,0xFF 
opfunc MAC_L
mov  rbp,rdi                  ;2  
add  rbp,byte $00             ;3 4..7
mov  ecx,dword [rbp]          ;3
...
;        (MACH << 32 + MACL)  + ans 
;-------------------------------------------------------------
opdesc MAC_W,	68,6,39,0xFF,0xFF,0xFF
opfunc MAC_W
mov  rbp,rdi                  ;2  
add  rbp,byte $00             ;3 4..7
mov  ecx,dword [rbp]          ;3
