...
DYNAREC_MSABI void memSetByteNoCache(u32 addr, u8 data)
{
  dynaLock();
  u32 cycle = 0;
...
DYNAREC_MSABI void memSetWordNoCache(u32 addr, u16 data)
{
  dynaLock();
  u32 cycle = 0;
  //LOG("memSetWord %08X, %08X\n", addr, data);
...
DYNAREC_MSABI void memSetLongNoCache(u32 addr, u32 data)
{
  dynaLock();
...
DYNAREC_MSABI u8 memGetByteNoCache(u32 addr)
{
  dynaLock();
  u8 val;
  u32 cycle = 0;
...
DYNAREC_MSABI u16 memGetWordNoCache(u32 addr)
{
  dynaLock();
  u16 val;
  u32 cycle = 0;
...
DYNAREC_MSABI u32 memGetLongNoCache(u32 addr)
{
  dynaLock();
...
DYNAREC_MSABI void memSetByte(u32 addr , u8 data )
{
  dynaLock();
  u32 cycle = 0;
  CompileBlocks * block = CompileBlocks::getInstance();
...
DYNAREC_MSABI void memSetWord(u32 addr, u16 data )
{
  dynaLock();
  u32 cycle = 0;
  CompileBlocks * block = CompileBlocks::getInstance();
...
DYNAREC_MSABI void memSetLong(u32 addr , u32 data )
{
  dynaLock();
...
DYNAREC_MSABI u8 memGetByte(u32 addr)
{
  dynaLock();
  u32 cycle = 0;
...
DYNAREC_MSABI u16 memGetWord(u32 addr)
{
  dynaLock();
  u32 cycle = 0;
...
DYNAREC_MSABI u32 memGetLong(u32 addr)
{
  dynaLock();
  u32 cycle = 0;
